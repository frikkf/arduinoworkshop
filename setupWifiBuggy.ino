...
void logLightSensorData() {
    ...
    Serial.print("\n");
    uploadToThingSpeak(String(sensorData), "field2");
...
void logTempSensorData() {
    ...
    Serial.print("\n");
    uploadToThingSpeak(String(temperature), "field1");
...
void logDataToCloud() {
  if (millis() - lastConnectionTime > postingInterval) {
    float temp = getTempSensorTemperatur();
    int light = getLightSensorData();
    sendThingspeak(String(temp),String(light));
